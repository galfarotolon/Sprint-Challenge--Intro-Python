...
# make list containing all letters asked to filter by:
letters_including = ['C', 'D', 'E', 'F', 'G']


print("Starts between C and G, inclusive:")

# check list above, if letter matches first letter of humans list, add to 'c' list

c = [person.name for person in humans if person.name[0] in letters_including]
print(c)
